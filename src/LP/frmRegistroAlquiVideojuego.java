 ...
 * Formulario utilizado para ver los registros de videojuegos alquilados.
 * Hereda de JInternalFrame, implementa ActionListener
 */
public class frmRegistroAlquiVideojuego extends JInternalFrame implements ActionListener
{
	...
	CopyOnWriteArrayList<clsVideojuego_Alquilado> alqui;
	 ...
	 * Lee de fichero la lista de alquileres de videojuegos.
	 * Llama al método CreateAndShowGUI()
	 * @param title
	 */
	public frmRegistroAlquiVideojuego(String title)
	{
		
		super(title);
		
		setTitle("Lista de alquileres de videojuegos realizados");
		

		clsGestor objGestor= new clsGestor();
		alqui=objGestor.ListaAlquileresVideojuegos();
	...
	/**
	 * Método que crea la tabla de alquileres de videojuegos.
	 * @return void
	 */
	private void crearTablaAlquileres()
	{
		...
		TablaRegistroAlquileresVideojuegosModel tcm=new TablaRegistroAlquileresVideojuegosModel(alqui);
	...
	/**
	 * 
	 *	Clase que se encarga de la creación de un JTable de videojuegos alquilados.
	 */
	class TablaRegistroAlquileresVideojuegosModel extends AbstractTableModel
    {
        private String[] columnNames = {"Nickname usuario", "Código película"};
        Object[][] data;
        
        public TablaRegistroAlquileresVideojuegosModel(CopyOnWriteArrayList<clsVideojuego_Alquilado> alqui)
        {
    		...
    		for (clsVideojuego_Alquilado aux : alqui)
    		{
