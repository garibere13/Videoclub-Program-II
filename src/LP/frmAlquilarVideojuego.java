...
public class frmAlquilarVideojuego extends JInternalFrame implements ActionListener
{
	 ...
	 * En la tabla solo aparecerán los videojuegos que sean para alquilar y que estén libres(condición true).
	 * @return void
	 */
	...
	/**
	 * Método que crea un nuevo alquiler de videojuego en caso de haber escogido un elemento de la tabla.
	 * El elemento escogido pasará a tener condición false y no aparecerá más en la tabla de alquileres de videojuegos hasta que sea devuelto.
	 * @return void
	 */
